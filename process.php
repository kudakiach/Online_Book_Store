<?php
	...
	if(strlen($card_PID) < 3 || strlen($card_PID) > 3){
		echo "The card PID is invalid";
		exit;
	}
	...
	session_unset();
?>
	<p class="lead text-success">order processed sucessfully. Kindly check your email to get your order confirmation. 
