...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" name="name" class="col-md-8" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="address" class="control-label col-md-4">Address</label>
			<div class="col-md-8">
				<input type="text" name="address" class="col-md-8" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="city" class="control-label col-md-4">City</label>
			<div class="col-md-8">
				<input type="text" name="city" class="col-md-8" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="zip_code" class="control-label col-md-4">Zip Code</label>
			<div class="col-md-8">
				<input type="text" name="zip_code" class="col-md-8" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="country" class="control-label col-md-4">Country</label>
			<div class="col-md-8">
				<input type="text" name="country" class="col-md-8" class="form-control">
			</div>
		</div>
		<div class="form-group">
